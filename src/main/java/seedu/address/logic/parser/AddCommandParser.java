...
public class AddCommandParser implements Parser<AddCommand> {
     ...
     *
     * @param argumentMultimap Argument map containing user inputs.
     * @param prefixes Required prefixes to check.
     * @return {@code true} if all prefixes have values, otherwise {@code false}.
     */
