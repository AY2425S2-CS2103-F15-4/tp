...
public class PersonBuilder {
    ...
    private RemarkTutorialHY remark;
    ...
    public PersonBuilder() {
        ...
        remark = new RemarkTutorialHY(DEFAULT_REMARK);
    ...
    public PersonBuilder withRemark(String remark) {
        this.remark = new RemarkTutorialHY(remark);
        return this;
    }
    ...
    public Person build() {
        return new Person(name, phone, email, address, remark ,attendanceList, tags);
    }
